...
#   run_command("rm -rf /home/mn{}/.arenacore/".format(xth))

#   print_info('Copying wallet data from the first masternode...')
#   run_command("cp -rf /home/mn1/.arenacore /home/mn{}/".format(xth))
#   run_command("sudo chown -R mn{}:mn{} /home/mn{}/.arenacore".format(xth, xth, xth))
#   run_command("rm /home/mn{}/.arenacore/peers.dat &> /dev/null".format(xth))
#   run_command("rm /home/mn{}/.arenacore/wallet.dat &> /dev/null".format(xth))
