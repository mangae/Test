...
# cat -n ~/.arenacore/arena.conf | grep -l 15
tail -n 1 ~/.arenacore/arena.conf
echo "Your Arena VPS is ready to be started as Masternode, please use Masternode private key printed above for your local wallet masternode configuration."
