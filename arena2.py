...
def compile_wallet():
	...
	run_command("apt-get --assume-yes install autoconf automake")
	run_command("apt-get --assume-yes install libssl-dev libevent-dev")
	run_command("apt-get --assume-yes install libboost-all-dev pkg-config")
