...
masternodekey=$(./arenacli-cli masternode genkey)
echo "Please record masternode private key and store it for your local wallet configuration and press [ENTER]:"
arena-cli stop
