...
if [[ $(lsb_release -d) == *16.04* ]]; then
	...
	sudo unzip /Innova-Ubuntu-16.04/Innova-Ubuntu-16.04.zip
	sudo cp /Innova-Ubuntu-16.04/innovad /usr/local/bin
	sudo cp /Innova-Ubuntu-16.04/innova-cli /usr/local/bin
