...
def compile_wallet():
	...
	run_command("apt-get install git unzip software-properties-common build-essential libtool autotools-dev autoconf automake libssl-dev libevent-dev libboost-all-dev pkg-config libdb4.8-dev libdb4.8++-dev libminiupnpc-dev libzmq3-dev libevent-pthreads-2.0-5 libqt5gui5 libqt5core5a libqt5dbus5 libprotobuf-dev git --assume-yes")
